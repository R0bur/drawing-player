...
i18n.strTable.ru = {
	...
	/* Решение задачи. */
	76: "+Задание ВЫПОЛНЕНО!",
	77: "-Задание НЕ выполнено, потому что:",
	78: "не все заданные отрезки закрашены (%1)",
	79: "некоторые отрезки закрашены ошибочно (%1)",
	80: "исполнитель не занял требуемое положение",
	81: "Введите упакованное условие задачи (пустая строка убирает поставленную задачу).\nВставка из буфера обмена: Ctrl+V, Enter.",
	82: "Ошибка: не удалось распаковать условие задачи!",
	83: "Вот строка с упакованным условием задачи.\nКопирование в буфер обмена: Ctrl+C, Enter.",
	/*------------*/
	/* program.js */
	/*------------*/
